$(function () {
    ...
    template.defaults.imports.dataFormat = function(date) {
        ...
        let m = dt.getMonth() + 1
        // let m = dt.PadZero(getMonth() + 1)
        let d = dt.getDate()
        // let d = dt.PadZero(getDate())

        let hh = dt.getHours()
        // let hh = dt.PadZero(getHours())
        let mm = dt.getMinutes()
        // let mm = dt.PadZero(getMinutes())
        let ss = dt.getSeconds()
        // let ss = dt.PadZero(getSeconds())
